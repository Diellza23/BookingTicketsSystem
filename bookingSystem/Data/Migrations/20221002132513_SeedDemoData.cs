    ...
    public partial class SeedDemoData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            DECLARE @UserID as INT
                ...
                --Create User
                --------------------------
                IF not exists (select Id from AppUser where Username='Demo')
                insert into AppUser(Username,Password, PasswordKey,LastUpdatedOn,LastUpdatedBy)
                select 'Demo',
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
                ...
                --------------------
                DECLARE @UserID as int
                SET @UserID = (select id from AppUser where Username='Demo')
